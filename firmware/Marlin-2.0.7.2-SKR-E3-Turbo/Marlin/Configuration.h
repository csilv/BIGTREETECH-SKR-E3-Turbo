...
#define STRING_CONFIG_H_AUTHOR "(BIGTREETECH, Ender-3, csilv)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "csilv-E3 v3"
...
#define TEMP_SENSOR_CHAMBER 1  // CSILV:ENABLED
